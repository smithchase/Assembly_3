...
.data
	...
	QUEUEA		byte	NUMOMSGS*PacketSize dup(0)
...
PuttIt PROC
	...
	; copy from xmt buffer into queue
	push edi
	mov esi, offset XMTBUFFER[edi]
	mov ecx, PacketSize
	cld
	mov edi, inptr[edi]
	rep movsb
	...
	; post update the pointer
	mov edx, inptr[edi]			; get queue
