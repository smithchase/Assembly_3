...
main PROC
	...
	mov edx, offset AXMTE	; did it go to buffer?
	mov ecx, PacketSize
	Call WriteString
	Call Crlf

	mov esi, offset NodeE	; CALL GETTIT
	mov eax,2
	Call GettIt

	mov edx, offset QUEUEE	; did it go to queue
	mov ecx, PacketSize
	Call WriteString
	Call Crlf

	mov edx, offset AXMTE	; did it leave buffer?
	mov ecx, PacketSize
	Call WriteString
	Call Crlf
